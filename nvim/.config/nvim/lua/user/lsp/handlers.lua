...
local function lsp_keymaps(bufnr)
    ...
    buf_set_keymap("n", "pd", '<cmd>lua vim.diagnostic.goto_prev({ border = "rounded" })<CR>', opts)
    buf_set_keymap("n", "gl", '<cmd>lua vim.diagnostic.open_float({ border = "rounded" })<CR>', opts)
    buf_set_keymap("n", "nd", '<cmd>lua vim.diagnostic.goto_next({ border = "rounded" })<CR>', opts)
